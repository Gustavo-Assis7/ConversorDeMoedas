...
public class Principal {
    ...
    public static double obterTaxaDeCambio(String de, String para) {
        if (de.equals("USD") && para.equals("BRL"))
            return 5.30;
        if (de.equals("EUR") && para.equals("BRL"))
            return 5.70;
        if (de.equals("BRL") && para.equals("USD"))
            return 0.19;
        if (de.equals("BRL") && para.equals("EUR"))
            return 0.175;
        if (de.equals("USD") && para.equals("EUR"))
            return 0.88;
        if (de.equals("EUR") && para.equals("USD"))
            return 1.14;
